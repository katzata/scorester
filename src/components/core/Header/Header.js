...
export default function Header() {
    ...
    // const [gameOptionsVisible, setGameSettingsVisible] = useState(false);
    ...
    return <header>
        ...
        <div className={styles.buttonsContainer}>
            <div className={styles.buttonWrapper}>
                ...
                <Modal isVisible={userOptionsVisible} visibilityHandler={setUserOptionsVisible}>
                    <GameSettings />
                </Modal>
            </div>
            ...
            <div className={styles.buttonWrapper}>
                ...
                {/* <Modal isVisible={gameOptionsVisible} visibilityHandler={setGameSettingsVisible} options={gameOptions}>
                    <Form/>
                </Modal> */}
            </div>
        </div>
